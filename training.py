...
train_ds = datasets.ImageFolder(root=r'/work/dat.lt19010205/Face-Verification/Face Dataset', transform=transforms)
train_loader = DataLoader(train_ds, batch_size=2, shuffle=True)
num_classes = len(train_loader.dataset.classes)
model = FaceVerification(num_classes=num_classes)
